            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">New Prosecution Under Cr.PC. Acts</h4>
                        <ol class="breadcrumb p-0 m-0">
                            <li><a href="#">Dashboard</a></li>
                            <li><a href="#">Data</a></li>
                            <li><a href="#">Special Report</a></li>
                            <li><a href="<?php echo base_url();?>SpecialReport/ProsecutionUnderCrpcActs">Prosecution Under Cr.PC. Acts List</a></li>
                    ...
                    <div class="panel panel-color panel-teal">
                        ...
                        <div class="panel-body append_panel">
                            <div class="append_row">
                                <div class="row">
                                    <div class="col-md-1 col-lg-1 col-sm-12 col-xs-12 sl">
                                        <label for="slno">Sl No.</label>
                                        <input type="text" readonly="readonly" class="form-control slno" name="" id="slno" value="">
                                    </div>
                                </div>
                                <br/>
                                <div class="row">
