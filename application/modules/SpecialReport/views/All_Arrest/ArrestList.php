            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">All Arrest Listing</h4>
                        <ol class="breadcrumb p-0 m-0">
                            <li><a href="#">Dashboard</a></li>
                            <li><a href="#">Data</a></li>
                            <li><a href="#">Special Report</a></li>
                            <li class="active">All Arrest Listing</li>
                        </ol>
                    ...
                    <div class="card-box">
                        <div class="row">
                            ...
                            <div class="text-right">
                                <a class="btn btn-primary btn-rounded waves-effect waves-light" href="<?php echo base_url(); ?>SpecialReport/AllArrest/addnew"><i class="fa fa-plus"></i> Add New</a>
                            </div>
                        </div>
                        <hr/>
